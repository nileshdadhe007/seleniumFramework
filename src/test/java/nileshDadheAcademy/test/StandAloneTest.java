...
public class StandAloneTest {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("nileshdadhe2403@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Malhar@170823");
		...
		String actualString = driver.findElement(By.className("hero-primary")).getText();
		Assert.assertTrue(actualString.equalsIgnoreCase("THANKYOU FOR THE ORDER."));
